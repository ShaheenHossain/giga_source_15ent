...
from giga.tools import (config, existing_tables, ignore,
                        lazy_classproperty, lazy_property, sql,
                        Collector, OrderedSet)
from giga.tools.lru import LRU

_logger = logging.getLogger(__name__)
_schema = logging.getLogger('giga.schema')
...
class Registry(Mapping):
    ...
    def __new__(cls, db_name):
        ...
        with cls._lock:
            try:
                ...
                # giga.service.wsgi_server.application
    ...
    def new(cls, db_name, force_demo=False, status=None, update_module=False):
        ...
        with cls._lock:
            ...
            try:
                ...
                try:
                    giga.modules.load_modules(registry, force_demo, status, update_module)
                except Exception:
                    giga.modules.reset_modules_state(db_name)
                    raise
            except Exception:
    ...
    def init(self, db_name):
        ...
        self._init = True
        self._assertion_report = giga.tests.runner.GigaTestResult()
        ...
        self._db = giga.sql_db.db_connect(db_name)
        ...
        with closing(self.cursor()) as cr:
            self.has_unaccent = giga.modules.db.has_unaccent(cr)
            self.has_trigram = giga.modules.db.has_trigram(cr)
    ...
    def cursor(self):
        ...
        cr.transaction = giga.api.Transaction(self)
        return cr
