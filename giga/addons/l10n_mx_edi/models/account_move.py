...
from giga.tools.float_utils import float_repr
...
class AccountMove(models.Model):
    ...
    def l10n_mx_edi_update_sat_status(self):
        '''Synchronize both systems: Giga & SAT to make sure the invoice is valid.
        '''
 ...
 xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
   ...
   <ns1:Body>
    ...
    def _l10n_mx_edi_cron_update_sat_status(self):
        ...
        In the second case, the cancellation could be done Giga-side and then we need to check if the SAT is up-to-date,
        or could be done manually government-side forcing Giga to update the invoice's state.
        '''
