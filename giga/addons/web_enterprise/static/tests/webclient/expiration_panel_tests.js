...
import { ExpirationPanel } from "@web_enterprise/webclient/home_menu";
...
QUnit.module("web_enterprise", {}, function () {
    ...
    QUnit.test("Expiration Panel one app installed, buy subscription", async function (assert) {
        ...
        assert.strictEqual(
            browser.location,
            "https://www.gigasource.de/giga-enterprise/upgrade?num_users=7"
        );
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.strictEqual(
                panel.el.querySelector(".oe_instance_register").innerText,
                "Something went wrong while registering your database. You can try again or contact Giga Support."
            );
            assert.hasClass(panel.el, "alert-danger", "Color should be red");
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.strictEqual(
                ...
                - Login to your gigasource.de dashboard then unlink your previous database: www.super_company.com
            ...
            assert.strictEqual(
                ...
                - Login to your gigasource.de dashboard then unlink your previous database: www.super_company.com
                - Click here to send an email to the subscription owner (email: super_company_admin@gmail.com) with the instructions to follow
                Unable to send the instructions by email, please contact the Giga Support
    ...
    QUnit.test("One app installed, upgrade database", async function (assert) {
        ...
        assert.strictEqual(
            browser.location,
            "https://www.gigasource.de/giga-enterprise/upsell?num_users=13&contract=ABC"
        );
