...
from giga.addons.payment_stripe.const import INTENT_STATUS_MAPPING, PAYMENT_METHOD_TYPES
from giga.addons.payment_stripe.controllers.main import StripeController
    ...
    def _stripe_create_customer(self):
        ...
        customer = self.acquirer_id._stripe_make_request(
            'customers', payload={
                ...
                'description': f'Giga Partner: {self.partner_id.name} (id: {self.partner_id.id})',
