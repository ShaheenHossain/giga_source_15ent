...
from giga import api, fields, models, tools, SUPERUSER_ID
from giga.addons.base.models.res_partner import _tz_get
from giga.addons.resource.models.resource import float_to_time, HOURS_PER_DAY
from giga.exceptions import AccessError, UserError, ValidationError
from giga.tools import float_compare
from giga.tools.float_utils import float_round
        ...
        for holiday in holidays:
            if not self._context.get('leave_fast_create'):
                ...
                if holiday.validation_type == 'no_validation':
                    ...
                    holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype_xmlid="mail.mt_comment") # Message from Giga SourceBot (sudo)
