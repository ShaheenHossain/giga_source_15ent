...
import giga
from giga import api, models, registry, exceptions, tools
from giga.addons.base.models import ir_http
from giga.addons.base.models.ir_http import RequestUID
from giga.addons.base.models.qweb import QWebException
from giga.http import request
from giga.osv import expression
from giga.tools import config, ustr, pycompat
...
class IrHttp(models.AbstractModel):
    ...
    def _geoip_setup_resolver(cls):
        ...
        if giga._geoip_resolver is not None:
            return
        geofile = config.get('geoip_database')
        try:
            giga._geoip_resolver = GeoIPResolver.open(geofile) or False
    ...
    def _geoip_resolve(cls):
        if 'geoip' not in request.session:
            record = {}
            if giga._geoip_resolver and request.httprequest.remote_addr:
                record = giga._geoip_resolver.resolve(request.httprequest.remote_addr) or {}
    ...
    def _postprocess_args(cls, arguments, rule):
        ...
        except giga.exceptions.MissingError:
