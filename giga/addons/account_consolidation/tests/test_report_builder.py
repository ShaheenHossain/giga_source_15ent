...
from giga.addons.account_consolidation.report.builder.comparison import ComparisonBuilder
from giga.addons.account_consolidation.report.builder.comparison import ComparisonBuilder
from giga.addons.account_consolidation.report.builder.default import DefaultBuilder
...
class TestAbstractBuilder(AccountConsolidationTestCase):
    ...
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._get_hierarchy')
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._get_plain')
    ...
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_accounts')
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._build_total_line')
    ...
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_orphan_accounts')
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._get_root_sections')
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_sections')
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._build_total_line')
    ...
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._build_section_line')
    @patch(
        'giga.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler.section_line_should_be_added',
        return_value=True)
    ...
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._get_orphan_accounts')
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_accounts')
    ...
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._compute_account_totals')
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._format_account_line')
    @patch('giga.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler.account_line_should_be_added',
           return_value=True)
...
class TestComparisonBuilder(AccountConsolidationTestCase):
    ...
    @patch('giga.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler.section_line_should_be_added',
           return_value=True)
    @patch('giga.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler.account_line_should_be_added',
           return_value=True)
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._compute_account_totals')
    ...
    @patch('giga.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._build_percentage_column',
