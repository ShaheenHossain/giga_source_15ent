...
from giga.addons.account_consolidation.report.handler.abstract import AbstractHandler
from giga.addons.account_consolidation.report.handler.journals import JournalsHandler
from giga.addons.account_consolidation.report.handler.periods import PeriodsHandler
from giga.addons.account_consolidation.report.handler.show_zero import ShowZeroHandler
...
class TestAbstractHandler(TransactionCase):
    ...
    @patch('giga.addons.account_consolidation.report.handler.abstract.AbstractHandler.get_selected_values')
...
class TestJournalHandler(AccountConsolidationTestCase):
    ...
    @patch('giga.addons.account_consolidation.report.handler.periods.PeriodsHandler.is_set')
    @patch('giga.addons.account_consolidation.report.handler.journals.JournalsHandler.get_option_values')
...
class TestPeriodsHandler(AccountConsolidationTestCase):
    ...
    @patch('giga.addons.account_consolidation.report.handler.periods.PeriodsHandler.get_selected_values',
           return_value=[1, 3])
...
class TestShowZeroHandler(AccountConsolidationTestCase):
    @patch('giga.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler._line_is_not_zero')
    ...
    @patch('giga.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler._section_line_is_not_zero')
    @patch('giga.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler._section_line_has_children')
