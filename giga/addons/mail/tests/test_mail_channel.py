...
from giga import Command, fields
from giga.addons.mail.models.mail_channel import channel_avatar, group_avatar
from giga.addons.mail.tests.common import mail_new_test_user
from giga.addons.mail.tests.common import MailCommon
from giga.exceptions import AccessError
from giga.tests import tagged, Form
from giga.tests.common import users
from giga.tools import html_escape, mute_logger
from giga.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
...
class TestChannelAccessRights(MailCommon):
    ...
    @mute_logger('giga.addons.base.models.ir_rule', 'giga.addons.base.models.ir_model', 'giga.models')
    @users('user_public')
    ...
    @mute_logger('giga.addons.base.models.ir_rule', 'giga.models', 'giga.models.unlink')
    @users('employee')
    ...
    @mute_logger('giga.addons.base.models.ir_rule', 'giga.models')
    @users('user_portal')
