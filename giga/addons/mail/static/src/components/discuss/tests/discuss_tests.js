...
QUnit.test('receive new chat message: out of giga focus (notification, channel)', async function (assert) {
    assert.expect(4);
    ...
    // simulate receiving a new message with giga focused
    await afterNextRender(() => {
        const messageData = {
            id: 126,
            model: 'mail.channel',
...
QUnit.test('receive new chat message: out of giga focus (notification, chat)', async function (assert) {
    assert.expect(4);
...
QUnit.test('receive new chat messages: out of giga focus (tab title)', async function (assert) {
    assert.expect(12);
    ...
    // simulate receiving a new message in chat 20 with giga focused
    await afterNextRender(() => {
        const messageData1 = {
            id: 126,
            model: 'mail.channel',
    ...
    // simulate receiving a new message in chat 10 with giga focused
    await afterNextRender(() => {
        const messageData2 = {
            id: 127,
            model: 'mail.channel',
    ...
    // simulate receiving another new message in chat 10 with giga focused
    await afterNextRender(() => {
        const messageData3 = {
            id: 128,
            model: 'mail.channel',
