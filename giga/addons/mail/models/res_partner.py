...
from giga.addons.bus.models.bus_presence import AWAY_TIMER
from giga.addons.bus.models.bus_presence import DISCONNECTION_TIMER
...
class Partner(models.Model):
    ...
    def _compute_im_status(self):
        ...
        gigabot = self.env['res.partner'].browse(gigabot_id)
        if gigabot in self:
            gigabot.im_status = 'bot'
