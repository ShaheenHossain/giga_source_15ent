...
function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('giga-google-map'), {
        zoom: 1,
    ...
    if (giga_partner_data){ /* giga_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < giga_partner_data.counter; i++) {
            set_marker(giga_partner_data.partners[i]);
        }
