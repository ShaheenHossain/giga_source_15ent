...
from giga.addons.web.controllers.main import xml2json_from_elementtree
from giga.exceptions import UserError
from giga.tools.translate import _
from giga.tools import DEFAULT_SERVER_DATE_FORMAT
...
class ResCompany(models.Model):
    ...
    def _generate_currency_rates(self, parsed_data):
        ...
        exchange rate of their main currency equal to one in Giga.
        """
    ...
    def _parse_bcrp_data(self, available_currencies):
        ...
        for currency_giga_code, currency_pe_code in foreigns.items():
            if currency_giga_code not in available_currency_names:
                continue
            ...
            result[currency_giga_code] = (rate, date_rate)
        return result
