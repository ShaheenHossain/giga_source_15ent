...
from giga import models, api, _, _lt
from giga.addons.iap.tools.iap_tools import iap_jsonrpc
from giga.exceptions import AccessError
from giga.tools import html_escape

DEFAULT_IAP_ENDPOINT = 'https://iap-pe-edi.gigasource.de'
DEFAULT_IAP_TEST_ENDPOINT = 'https://l10n-pe-edi-proxy-demo.gigasource.de'
...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_pe_edi_get_cdr_error_messages(self):
        ...
        return {
            ...
            '154': _lt("Your RUC is not linked to Digiflow as OSE, please make sure you have follow this process in the SUNAT portal:\n"
                       ...
                       "Reference: \n"
                       "https://www.gigasource.de/documentation/user/14.0/accounting/fiscal_localizations/localizations/peru.html#what-do-you-need-to-do"),
        }
    ...
    def _l10n_pe_edi_get_iap_buy_credits_message(self, company):
        base_url = 'https://iap-sandbox.gigasource.de/iap/1/credit' if company.l10n_pe_edi_test_env else ''
