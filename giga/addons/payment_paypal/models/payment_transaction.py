...
from giga.addons.payment_paypal.const import PAYMENT_STATUS_MAPPING
from giga.addons.payment_paypal.controllers.main import PaypalController
...
class PaymentTransaction(models.Model):
    ...
    paypal_type = fields.Char(
        string="PayPal Transaction Type", help="This has no use in Giga except for debugging.")
