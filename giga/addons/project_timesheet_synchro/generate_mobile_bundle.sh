...
#
echo "Creating 'www' bundle for cordova app in directory GigaTimesheets"

./generate_extension.sh

cordova create GigaTimesheets com.giga.GigaTimesheets GigaTimesheets
cd GigaTimesheets
...
app_author='Giga Source ERP'
app_author_email='help@gigasource.de'
app_author_website='https://www.gigasource.de/'
