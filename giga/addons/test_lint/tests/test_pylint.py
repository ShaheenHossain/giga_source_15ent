...
from giga.modules import get_modules, get_module_path
...
class TestPyLint(TransactionCase):
    ...
    def test_pylint(self):
        ...
        options = [
            ...
            '--load-plugins=pylint.extensions.bad_builtin,_giga_checker_sql_injection,_giga_checker_gettext,_giga_checker_unlink_override',
