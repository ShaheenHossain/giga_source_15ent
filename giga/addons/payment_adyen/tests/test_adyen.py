...
class AdyenForm(AdyenCommon):
    ...
    def test_processing_values(self):
        ...
        with mute_logger('giga.addons.payment.models.payment_transaction'), \
            patch(
                'giga.addons.payment.utils.generate_access_token',
        ...
        with patch(
            'giga.addons.payment.utils.generate_access_token', new=self._generate_test_access_token
        ):
    ...
    @mute_logger('giga.addons.payment_adyen.models.payment_transaction')
    def test_send_refund_request(self):
        ...
        with patch(
            'giga.addons.payment_adyen.models.payment_acquirer.PaymentAcquirer._adyen_make_request',
