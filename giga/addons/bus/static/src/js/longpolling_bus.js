giga.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether giga is focused or not
     *
     * @returns {boolean}
     */
    isGigaFocused: function () {
        return this._isGigaFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isGigaFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isGigaFocused);
        }
    },
    /**
