/** @giga-module alias=documents_spreadsheet.OperationalTransform */
...
otRegistry
    ...
    .addTransformation("ADD_EAGLE_LIST", ["ADD_EAGLE_LIST_FORMULA"], (toTransform) => ({
        ...toTransform,
        args: [toTransform.args[0] + 1, ...toTransform.args.slice(1)],
    }))
    .addTransformation("ADD_EAGLE_LIST", ["ADD_EAGLE_LIST"], (toTransform) => ({
        ...toTransform,
...
inverseCommandRegistry
    ...
    .add("ADD_EAGLE_LIST", identity)
    .add("ADD_EAGLE_LIST_FORMULA", identity);
