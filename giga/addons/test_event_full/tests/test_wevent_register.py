...
from giga.addons.test_event_full.tests.common import TestWEventCommon
from giga.tests.common import HOST
...
class TestWEventRegister(TestWEventCommon):
    ...
    def test_register(self):
        self.browser_js(
            '/event',
            'giga.__DEBUG__.services["web_tour.tour"].run("wevent_register")',
            'giga.__DEBUG__.services["web_tour.tour"].tours.wevent_register.ready',
            login=None
        )
