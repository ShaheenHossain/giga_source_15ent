...
from giga import _, api, fields, models, service
from giga.exceptions import ValidationError

from giga.addons.payment_mollie.const import SUPPORTED_CURRENCIES
...
class PaymentAcquirer(models.Model):
    ...
    def _mollie_make_request(self, endpoint, data=None, method='POST'):
        ...
        giga_version = service.common.exp_version()['server_version']
        ...
        headers = {
            ...
            "User-Agent": f'Giga/{giga_version} MollieGiga/{module_version}',
        }
