...
from giga.tests import TransactionCase, tagged, Form
from giga.addons.delivery_bpost.models.delivery_bpost import TRACKING_REF_DELIM
...
class TestDeliveryBpost(TransactionCase):
    ...
    def setUp(self):
        ...
        self.your_company.write({'name': 'Giga Source ERP',
        ...
        self.agrolait.write({'name': 'Giga Brussels',
        ...
        self.think_big_system.write({'name': "Palais de l'Élysee",
                                 ...
                                 'phone': '0142928100'})
        self.gigainc = self.env['res.partner'].create({'name': "Giga Inc.",
                                 'is_company': True,
