...
from giga.addons.auth_signup.models.res_users import SignupError
from giga.addons.web.controllers.main import ensure_db, Home
from giga.addons.base_setup.controllers.main import BaseSetup
