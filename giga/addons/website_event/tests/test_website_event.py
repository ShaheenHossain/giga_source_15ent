...
from giga.addons.base.tests.common import HttpCaseWithUserDemo
from giga.addons.mail.tests.common import mail_new_test_user
from giga.addons.website.tests.test_base_url import TestUrlCommon
from giga.addons.website_event.tests.common import TestWebsiteEventCommon
...
class TestWebsiteAccess(HttpCaseWithUserDemo, TestWebsiteEventCommon):
    ...
    @mute_logger('giga.addons.http_routing.models.ir_http')
