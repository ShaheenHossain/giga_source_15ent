...
from giga import Command, tools
from giga.addons.mail_group.tests.data import GROUP_TEMPLATE
from giga.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('giga.models.unlink', 'giga.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('giga.addons.base.models.ir_rule', 'giga.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('giga.addons.mail.models.mail_thread', 'giga.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('giga.addons.mail.models.mail_thread', 'giga.addons.mail_group.models.mail_group_message', 'giga.models.unlink')
    @users('employee')
    ...
    @mute_logger('giga.addons.mail_group.models.mail_group')
    @users('employee')
