...
from giga.addons.test_marketing_automation.tests.common import TestMACommon
from giga.fields import Datetime
from giga.tests import tagged, users
...
for record in records:
    ...
    @mute_logger('giga.addons.base.models.ir_model', 'giga.addons.mail.models.mail_mail')
    @users('user_markauto')
