...
from giga import _, api, fields, models, SUPERUSER_ID
...
class PaymentAcquirer(models.Model):
    ...
    capture_manually = fields.Boolean(
        ...
        help="Capture the amount from Giga Source, when the delivery is completed.\n"
    ...
    module_to_buy = fields.Boolean(string="Giga Enterprise Module", related='module_id.to_buy')
