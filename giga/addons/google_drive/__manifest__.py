...

{
    ...
    'description': """
Integrate google document to Giga Source record.
============================================

This module allows you to integrate google documents to any of your Giga record quickly and easily using OAuth 2.0 for Installed Applications,
