...
from giga.addons.hw_drivers.connection_manager import connection_manager
...
from giga.addons.hw_drivers.iot_handlers.interfaces.PrinterInterface import PPDs, conn, cups_lock
...
class PrinterDriver(Driver):
    ...
    def send_status(self):
        """ Sends the current status of the printer to the connected Giga instance.
        """
        self.data = {
            'value': '',
            'state': self.state,
