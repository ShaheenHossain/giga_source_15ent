/* global GigaDeviceUtility */
giga.define('web_mobile.core', function () {
"use strict";

var available = typeof GigaDeviceUtility !== 'undefined';
var DeviceUtility;
var deferreds = {};
var methods = {};

if (available){
    DeviceUtility = GigaDeviceUtility;
    delete window.GigaDeviceUtility;
}
 ...
 * @param {Object} result
 */
window.giga.native_notify = function (id, result) {
