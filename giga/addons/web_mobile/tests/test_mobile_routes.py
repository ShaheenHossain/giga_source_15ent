...
from giga.tests.common import HttpCase, tagged
from giga.tools import config, mute_logger
...
class MobileRoutesTest(HttpCase):
    ...
    def test_version_info(self):
        """
        This request is used to check for a compatible Giga server
        """
    ...
    def test_database_list(self):
        ...
        if config['list_db']:
            ...
            self.assertEqual(error["message"], "Giga Source Server Error")
            self.assertEqual(error["data"]["name"], "giga.exceptions.AccessDenied")
