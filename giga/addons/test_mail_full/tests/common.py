...
from giga.addons.mass_mailing_sms.tests.common import MassSMSCommon
from giga.addons.test_mail.tests import common
...
class TestMailFullCommon(TestMassMailCommon, MassSMSCommon):
    ...
    def setUpClass(cls):
        ...
        cls.mailing_sms = cls.env['mailing.mailing'].with_user(cls.user_marketing).create({
            ...
            'body_plaintext': 'Dear {{ object.display_name }} this is a mass SMS with two links http://www.gigasource.de/smstest and http://www.gigasource.de/smstest/{{ object.id }}',
            'sms_force_send': True,
