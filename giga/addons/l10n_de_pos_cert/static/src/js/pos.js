giga.define('l10n_de_pos_cert.pos', function(require) {
    "use strict";
    ...
    models.PosModel = models.PosModel.extend({
         ...
         * send it to Giga Source. Two cases can happen:
         * - Failure to send to Fiskaly => we assume that if one order fails, EVERY order will fail
         * - Failure to send to Giga Source => the order is already sent to Fiskaly, we store them locally with the TSS info
         */
