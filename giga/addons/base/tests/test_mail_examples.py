...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
      type="cite"><base href="https://www.gigasource.de">
      <div dir="ltr">Yep Dominique that is true, as Postgres was the
        base of all same as Giga and MySQL etc came much later.Â 
        <div><br>
        </div>
    ...
    on this Giga mailinglist, but when you start implying that Postgres
...
HOTMAIL_1 = u"""<div>
    <div dir="ltr"><br>
        I have an amazing company, i'm learning GigaERP, it is a small company yet, but plannig to grow up quickly.
        <br><br>Kindest regards,<br>xxx<br>
        <div>
            <div id="SkyDrivePlaceholder">
            </div>
            <hr id="stopSpelling">
            Subject: Re: your GigaERP.com registration<br>From: xxx@xxx.xxx<br>To: xxx@xxx.xxx<br>Date: Wed, 27 Mar 2013 17:12:12 +0000
            <br><br>
            Hello xxx,
            <br>
            I noticed you recently created an GigaERP.com account to access GigaERP Apps.
            <br>
            You indicated that you wish to use GigaERP in your own company.
            ...
            Best regards,<br>
            <pre>
                <a href="http://gigasource.de" target="_blank">http://gigasource.de</a>
...
HOTMAIL_1_OUT = [
    ...
    u"""<pre data-o-mail-quote="1">
                <a href="http://gigasource.de" target="_blank" data-o-mail-quote="1">http://gigasource.de</a>
                Belgium: +32.81.81.37.00
                U.S.: +1 (650) 307-6736
                India: +91 (79) 40 500 100
            </pre>"""]
...
<div class="WordSection1">
        ...
        <p class="MsoNormal">
            <span style="font-size:11.0pt;font-family:&quot;Calibri&quot;,&quot;sans-serif&quot;;color:#1F497D">
                ...
                If we adopt GigaERP we will probably move to Linux or look for a hosted SaaS option.
            </span>
        </p>
        <p></p>
        <p></p>
            ...
            <div style="border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in">
                <p class="MsoNormal">
                    ...
                    <span style="font-size:10.0pt;font-family:&quot;Tahoma&quot;,&quot;sans-serif&quot;">
                        GigaERP Enterprise [mailto:sales@gigasource.de]
                        <br><b>Sent:</b> Monday, 11 March, 2013 14:47<br><b>To:</b> Alan Widmer<br><b>Subject:</b> Re: your GigaERP.com registration
                    </span>
                </p>
                <p></p>
                <p></p>
        ...
        <p></p>
        <p>I noticed you recently downloaded GigaERP. </p>
        <p></p>
        <p>
            Uou mentioned you wish to use GigaERP in your own company. Please let me more about your
            business needs and requirements? When will you be available to discuss about your project?
        </p>
        <p></p>
        <p>Thanks for your interest in GigaERP, </p>
        <p></p>
        ...
        <pre>--<p></p></pre>
        <pre>Nicolas<p></p></pre>
        <pre><a href="http://gigasource.de">http://gigasource.de</a><p></p></pre>
...
MSOFFICE_1_OUT = [u'I noticed you recently downloaded GigaERP.', 'Uou mentioned you wish to use GigaERP in your own company.', 'Belgium: +32.81.81.37.00']
...
B-1367 Gérompont
Tel: +32.81.81.37.00
Web: http://www.gigasource.de</pre>"""
...
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed Giga 9 and I've got the following error:</div>
    <div>&nbsp;</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content openerp">
                <div class="modal-header"> 
                    <h4 class="modal-title">Giga Error<span class="o_subtitle text-muted"></span></h4>
                </div>
