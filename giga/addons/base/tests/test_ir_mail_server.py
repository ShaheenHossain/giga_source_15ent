...
from giga.addons.base.tests.common import MockSmtplibCase
...
class TestIrMailServer(TransactionCase, MockSmtplibCase):
    ...
    def test_mail_server_priorities(self):
        ...
        # remove the notifications email to simulate a mis-configured Giga database
        ...
        with mute_logger('giga.addons.base.models.ir_mail_server'):
    ...
    @mute_logger('giga.models.unlink')
    @patch.dict("giga.tools.config.options", {"from_filter": "test.com"})
    def test_mail_server_binary_arguments_domain(self):
        """Test the configuration provided in the giga-bin arguments.
        ...
        # Remove all mail server so we will use the giga-bin arguments
