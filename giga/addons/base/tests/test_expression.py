...
from giga.addons.base.tests.common import SavepointCaseWithUserDemo
...
class TestExpression(SavepointCaseWithUserDemo):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('giga.osv.expression'):
    ...
    def test_15_m2o(self):
        ...
        # that don't have GigaERP has a parent company, you expect to find,
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [Command.create({'name': 'address of GigaERP Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
