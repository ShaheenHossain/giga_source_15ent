...
from giga.tools import mute_logger, view_validation
from giga.addons.base.models.ir_ui_view import (
...
class TestApplyInheritanceSpecs(ViewCase):
    ...
    @mute_logger('giga.addons.base.models.ir_ui_view')
...
class TestViews(ViewCase):
    ...
    def test_partial_validation(self):
        ...
        with mute_logger('giga.addons.base.models.ir_ui_view'):
            with self.assertRaises(ValidationError):
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view'):
        with self.assertLogs('giga.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
