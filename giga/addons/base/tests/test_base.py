...
from giga import SUPERUSER_ID, Command
from giga.exceptions import RedirectWarning, UserError, ValidationError
from giga.tests.common import TransactionCase, BaseCase
from giga.tools import mute_logger
from giga.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('giga.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import giga", mode="exec")
