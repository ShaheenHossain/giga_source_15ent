...
from giga.addons.base.models.ir_mail_server import extract_rfc2822_addresses
from giga.tests.common import BaseCase, TransactionCase
from giga.tools import (
...
class EmailConfigCase(TransactionCase):
    @patch.dict("giga.tools.config.options", {"email_from": "settings@example.com"})
