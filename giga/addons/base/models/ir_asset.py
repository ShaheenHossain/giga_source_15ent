...
from giga import api, fields, http, models
...
class IrAsset(models.Model):
    ...
    def _get_installed_addons_list(self):
        ...
        return self.env.registry._init_modules | set(giga.conf.server_wide_modules or []) | set(self.env.context.get('install_module', []))
