...
from giga import api, models, _, Command
from giga.exceptions import AccessError, RedirectWarning, UserError
...
class ResConfigSettings(models.TransientModel, ResConfigModuleInstallationMixin):
    ...
    def get_config_warning(self, msg):
        ...
        Example of use:
        ---------------
        from giga.addons.base.models.res_config import get_warning_config
