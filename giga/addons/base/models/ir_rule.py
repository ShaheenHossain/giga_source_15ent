...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - giga/addons/test_access_rights/tests/test_feedback.py
        # - giga/addons/test_access_rights/tests/test_ir_rules.py
        # - giga/addons/base/tests/test_orm.py (/home/dle/src/giga/master-nochange-fp/giga/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res
