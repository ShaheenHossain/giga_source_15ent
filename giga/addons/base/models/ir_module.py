...
import giga
from giga import api, fields, models, modules, tools, _
from giga.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from giga.exceptions import AccessDenied, UserError
from giga.osv import expression
from giga.tools.parse_version import parse_version
from giga.tools.misc import topological_sort
...
class Module(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Giga Enterprise Edition License v1.0'),
        ('OPL-1', 'Giga Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Giga Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Giga is currently processing a scheduled action.\n"
    ...
    def install_from_urls(self, urls):
        ...
        OPENERP = giga.release.product_name.lower()
        ...
        try:
            ...
            for module_name, url in urls.items():
                ...
                try:
                    _logger.info('Downloading module `%s` from Giga SourceERP Apps', module_name)
            ...
            if urls.get(OPENERP):
                ...
                # copy all modules in the SERVER/giga/addons directory to the new "giga" module (except base itself)
                for d in os.listdir(base_path):
                    if d != 'base' and os.path.isdir(os.path.join(base_path, d)):
                        destdir = os.path.join(tmp, OPENERP, 'addons', d)    # XXX 'giga' subdirectory ?
                ...
                _logger.info('Copy downloaded module `giga` to `%s`', server_dir)
    ...
    def get_apps_server(self):
        return tools.config.get('apps_server', 'https://apps.gigasource.de/apps')
