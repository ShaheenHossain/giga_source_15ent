...
from giga.addons.microsoft_calendar.models.res_users import User
from giga.addons.microsoft_calendar.models.microsoft_sync import MicrosoftSync
...
class TestSyncGiga2Microsoft(TransactionCase):
    ...
    def test_restart_synchronization(self):
        ...
        event.with_user(user)._sync_giga2microsoft(self.microsoft_service)
