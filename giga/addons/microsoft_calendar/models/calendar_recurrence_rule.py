...
class RecurrenceRule(models.Model):
    ...
    def _write_from_microsoft(self, microsoft_event, vals):
        ...
        # event_tz is written on event in Microsoft but on recurrence in Giga
        ...
        new_event_values = self.env["calendar.event"]._microsoft_to_giga_values(microsoft_event)
    ...
    @api.model
    def _microsoft_to_giga_values(self, microsoft_recurrence, default_reminders=(), default_values={}):
