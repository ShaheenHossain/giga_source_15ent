...
<t t-set="httpurl" t-value="'https://www.giga.eu'"/>f
<span>Website0: <a id="url0" t-attf-href="https://www.giga.tz/my/{{object.name}}">https://www.giga.tz/my/<t t-out="object.name"/></a></span>
<span>Website1: <a id="url1" href="https://www.giga.be">https://www.giga.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test@gigasource.de">test@gigasource.de</a></span>
