...
from giga import SUPERUSER_ID, _, api, fields, models, registry
from giga.exceptions import UserError
from giga.osv import expression
from giga.tools import float_compare, float_is_zero, html_escape
from giga.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~giga.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~giga.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
