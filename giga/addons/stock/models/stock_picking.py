...
from giga import SUPERUSER_ID, _, api, fields, models
from giga.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
from giga.exceptions import UserError
from giga.osv import expression
from giga.tools import DEFAULT_SERVER_DATETIME_FORMAT, format_datetime
from giga.tools.float_utils import float_compare, float_is_zero, float_round
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, Giga will automatically pre-fill the detailed "
