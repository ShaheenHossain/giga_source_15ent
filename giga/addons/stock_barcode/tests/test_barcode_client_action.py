...
import giga
from giga.tests import Form, HttpCase, tagged
...
class TestPickingBarcodeClientAction(TestBarcodeClientAction):
    def test_internal_picking_from_scratch_1(self):
        ...
        picking_write_orig = giga.addons.stock.models.stock_picking.Picking.write
        ...
        with patch('giga.addons.stock.models.stock_picking.Picking.write', new=picking_write_mock):
