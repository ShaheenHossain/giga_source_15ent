...
from giga.addons.payment_sepa_direct_debit.models.sdd_mandate import INT_PHONE_NUMBER_FORMAT_REGEX
from giga.addons.phone_validation.tools.phone_validation import phone_sanitize_numbers
