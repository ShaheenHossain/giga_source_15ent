...
The eBay integrator gives you the opportunity to manage your Giga's products on eBay.
...
* Automatic creation of sales order and invoices
  ...
  # Check https://github.com/giga/giga/blob/master/giga/addons/base/data/ir_module_category_data.xml
  # for the full list
