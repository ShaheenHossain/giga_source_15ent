...
class TestAmazon(TestAmazonCommon):
    ...
    def test_check_credentials_succeed(self):
        ...
        with patch(
                'giga.addons.sale_amazon.models.mws_connector.do_account_credentials_check',
    ...
    def test_update_marketplaces_no_change(self):
        ...
        with patch(
                'giga.addons.sale_amazon.models.amazon_account.AmazonAccount'
    ...
    def test_sync_orders_full(self):
        ...
        with patch('giga.addons.sale_amazon.models.mws_connector.get_api_connector',
             ...
             patch('giga.addons.sale_amazon.models.amazon_account.AmazonAccount._get_product',
    ...
    def test_sync_orders_europe(self):
        ...
        with patch('giga.addons.sale_amazon.models.mws_connector.get_api_connector',
             ...
             patch('giga.addons.sale_amazon.models.mws_connector.get_items_data',
                   new=_get_items_data_mock), \
             patch('giga.addons.sale_amazon.models.amazon_account.AmazonAccount._recompute_subtotal',
    ...
    def test_sync_orders_cancel_abort(self):
        """ Test the pickings that were confirmed at giga and then order is canceled at amazon. """
    ...
    def test_get_partners_creation_contact(self):
        ...
        self.assertEqual(contact.city, 'GigaCity')
