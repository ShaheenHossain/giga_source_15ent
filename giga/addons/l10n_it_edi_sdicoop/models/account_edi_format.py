...
from giga import models, _, _lt
from giga.exceptions import UserError
from giga.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError, DEFAULT_SERVER_URL
        ...
        for invoice in invoices:
            ...
            if len(invoice.commercial_partner_id.l10n_it_pa_index or '') == 6:
                invoice.message_post(
                    body=(_("Invoices for PA are not managed by Giga, you can download the document and send it on your own."))
                )
