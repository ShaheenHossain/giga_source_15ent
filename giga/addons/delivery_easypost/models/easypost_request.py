...
from giga.tools.float_utils import float_round, float_is_zero
...
class EasypostRequest():
    ...
    def rate_request(self, carrier, recipient, shipper, order=False, picking=False, is_return=False):
        ...
        # reference field to track Giga customers that use easypost for postage/shipping.
        order_payload['order[reference]'] = 'giga'
