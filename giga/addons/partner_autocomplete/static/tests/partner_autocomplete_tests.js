giga.define('partner_autocomplete.tests', function (require) {
    "use strict";
    ...
    var suggestions = [{
        name: "Giga",
        website: "gigasource.de",
        domain: "gigasource.de",
        logo: "gigasource.de/logo.png",
        vat: "BE0477472701"
    }];
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "gigasource.de/logo.png" ? "gigabase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getGigaSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getGigaSuggestions(value);
                    },
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            testUtils.fields.editInput($input, "giga")
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/img/placeholder.png"
                    || route === "gigasource.de/logo.png"
                    || route === "data:image/png;base64,gigabase64") { // land here as it is not valid base64 content
            ...
            await testUtils.fields.editInput($input, "giga");
            ...
            assert.strictEqual($input.val(), "Giga", "Input value should have been updated to \"Giga\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "gigasource.de", "website value should have been updated to \"gigasource.de\"");
            ...
            await testUtils.nextTick();
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing giga letters again");
