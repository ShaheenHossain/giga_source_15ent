/* global Sha1 */
giga.define('pos_blackbox_be.pos_blackbox_be', function (require) {
            ...
            var prom = this.proxy.request_fdm_hash_and_sign(packet).then(function (parsed_response) {
                return new Promise(function (resolve, reject) {
                    if (parsed_response) {
                        ...
                        order.blackbox_pos_version = "Giga " + self.version.server_version + "1807BE_FDM";
...
//
        ...
        get_blackbox_terminal_id: function () {
            if (!localStorage.giga_pos_blackbox_pos_production_id) {
                ...
                localStorage.giga_pos_blackbox_pos_production_id = production_id;
            }

            return localStorage.giga_pos_blackbox_pos_production_id;
        },
