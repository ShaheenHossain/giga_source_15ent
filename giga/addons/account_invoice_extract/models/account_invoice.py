...
from giga import api, fields, models, tools, _lt
from giga.addons.iap.tools import iap_tools
from giga.exceptions import AccessError, ValidationError , UserError
from giga.tests.common import Form
from giga.tools import mute_logger
from giga.tools.misc import clean_context
import logging
import math
import re
import json
...
PARTNER_AUTOCOMPLETE_ENDPOINT = 'https://partner-autocomplete.gigasource.de'
EXTRACT_ENDPOINT = 'https://iap-extract.gigasource.de'
    ...
    def _save_form(self, ocr_results, no_ref=False):
        ...
        with Form(self_ctx) as move_form:
            ...
            if self.move_type in {'out_invoice', 'out_refund'}:
                with mute_logger('giga.tests.common.onchange'):
            ...
            if not move_form.invoice_line_ids:
                ...
                # if the total on the invoice doesn't match the total computed by Giga, adjust the taxes so that it matches
