...
from giga.addons.calendar.models.calendar_attendee import Attendee
from giga.addons.calendar.models.calendar_recurrence import weekday_to_field, RRULE_TYPE_SELECTION, END_TYPE_SELECTION, MONTH_BY_SELECTION, WEEKDAY_SELECTION, BYDAY_SELECTION
from giga.tools.translate import _
from giga.tools.misc import get_lang
from giga.tools import pycompat, html2plaintext, is_html_empty
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'Giga'
