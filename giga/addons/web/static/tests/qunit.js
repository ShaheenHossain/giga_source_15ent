(function () {
    ...
    async function checkModules() {
        ...
        await giga.__DEBUG__.didLogInfo;
        const info = giga.__DEBUG__.jsModules;
    ...
    QUnit.begin(function () {
        if (giga.__DEBUG__.services["@web/core/errors/error_utils"]) {
            const errorUtils = giga.__DEBUG__.services["@web/core/errors/error_utils"];
