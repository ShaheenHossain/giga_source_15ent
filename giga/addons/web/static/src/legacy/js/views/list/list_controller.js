/** @giga-module alias=web.ListController **/
...
var ListController = BasicController.extend({
    ...
    /**
     * Save the row in edition, if any, when we are about to leave Giga.
     *
     * @override
     */
    ...
    _onDiscardMousedown: function (ev) {
        ...
        window.addEventListener('mouseup', function (mouseupEvent) {
            ...
            if (ev.target !== mouseupEvent.target && preventedEvent.constructor.name === 'GigaEvent') {
