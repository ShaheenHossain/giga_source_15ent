/** @giga-module alias=web.AbstractView **/

/**
 * This is the base class inherited by all (JS) views. Giga JS views are the
 ...
 * the word 'view' has historical significance in Giga code, so we replaced the
