(function () {
    /**
     * Symbol used in ComponentWrapper to redirect Owl events to Giga Source legacy
     * events.
     */
    giga.widgetSymbol = Symbol('widget');
    ...
    owl.Component.prototype.__trigger = function (component, evType, payload) {
        if (this.env[giga.widgetSymbol]) {
            this.env[giga.widgetSymbol](evType);
        }
