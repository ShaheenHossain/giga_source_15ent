giga.define("web.commonEnv", function (require) {
    "use strict";

    /**
     * This file defines the common environment, which contains everything that
     * is needed in the env for both the backend and the frontend (Giga
     ...
     * on environments.
     *
     * [1] https://github.com/giga/owl/blob/master/doc/reference/environment.md#content-of-an-environment
     */
