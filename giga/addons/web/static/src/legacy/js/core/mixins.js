giga.define('web.mixins', function (require) {
"use strict";
...
function GigaEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
GigaEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

GigaEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
     ...
     * GigaERP Web where developers may want to replace existing callbacks with
     * theirs.
     *
    ...
    trigger_up: function (name, info) {
        var event = new GigaEvent(this, name, info);
