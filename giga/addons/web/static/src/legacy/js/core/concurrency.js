giga.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in Giga.
 *
 * The basic concurrency primitives in Giga JS are the callback, and the
...
return {
    ...
    /**
     * A (Giga) mutex is a primitive for serializing computations.  This is
