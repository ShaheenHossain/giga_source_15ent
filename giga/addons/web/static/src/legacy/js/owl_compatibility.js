giga.define('web.OwlCompatibility', function () {
    "use strict";

    /**
     * This file defines the necessary tools for the transition phase where Giga
    ...
    const widgetSymbol = giga.widgetSymbol;
     ...
     * adapter for Owl components that embed Giga legacy widgets (or dynamically
     * both Owl components and Giga legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends Component {
        ...
        /**
         * Mocks _trigger_up to redirect Giga legacy events to OWL events.
         *
         * @private
         * @param {GigaEvent} ev
         */
     ...
     * together when an Giga legacy widget needs to instantiate Owl components.
    ...
    class ComponentWrapper extends Component {
         ...
         * Giga legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType
