...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("GigaBeforeTestHook", "GigaAfterTestHook"); // Giga customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("GigaBeforeTestHook"); // Giga customization
  	...
  	finish: function finish() {
        ...
        emit("GigaAfterTestHook", this); // Giga customization
