...
See https://github.com/giga/owl/blob/master/doc/reference/config.md#mode for more information.`);
            }
        },
    });
    ...
    class Component {
         ...
         *  - it can be patched (useful in giga ecosystem)
  ...
  `;
    ...
    __info__.url = 'https://github.com/giga/owl';
