...
import giga
from giga import api, http, models
from giga.http import request
from giga.tools import file_open, image_process, ustr

from giga.addons.web.controllers.main import HomeStaticTemplateHelpers
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = giga.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.gigasource.de/buy",
            "name": user.name,
            "username": user.login,
    ...
    def _content_image_get_response(self, status, headers, image_base64, model='ir.attachment',
        ...
        if not image_base64:
            ...
            if not (width or height):
                width, height = giga.tools.image_guess_size_from_field_name(field)
        try:
