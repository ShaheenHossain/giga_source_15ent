...

{
    ...
    'version': '1.0',
    'description': """
Giga Web core module.
========================

This module provides the core of the Giga Web Client.
""",
    'depends': ['base'],
    'auto_install': True,
    'data': [
    ...
    'assets': {
        ...
        'web._assets_common_styles': [
            ...
            'web/static/src/legacy/scss/web.zoomgiga.scss',
        ...
        'web._assets_common_scripts': [
            ...
            'web/static/src/legacy/js/libs/zoomgiga.js',
