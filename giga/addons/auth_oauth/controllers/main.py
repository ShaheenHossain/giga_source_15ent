...
from giga import api, http, SUPERUSER_ID, _
from giga.exceptions import AccessDenied
from giga.http import request
from giga import registry as registry_get

from giga.addons.auth_signup.controllers.main import AuthSignupHome as Home
from giga.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via Giga Account provider"""
