...
from giga import api, fields, models, http, _, Command
from giga.tools import DEFAULT_SERVER_DATE_FORMAT, config, get_lang, is_html_empty, formataddr
...
class SignRequest(models.Model):
    ...
    def _message_send_mail(self, body, notif_template_xmlid, message_values, notif_values, mail_values, force_send=False, **kwargs):
        ...
        # See @tde-banana-giga for details
