giga.define('sign.views_custo', function(require) {
    'use strict';
...
giga.define('sign.template', function(require) {
    'use strict';
...
giga.define('sign.DocumentBackend', function (require) {
    'use strict';
    var AbstractAction = require('web.AbstractAction');
    var core = require('web.core');
...
giga.define('sign.document_edition', function(require) {
    'use strict';
...
giga.define('sign.document_signing_backend', function(require) {
    'use strict';
