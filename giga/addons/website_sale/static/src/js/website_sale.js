giga.define('website_sale.cart', function (require) {
'use strict';
...
giga.define('website_sale.website_sale_category', function (require) {
'use strict';
...
giga.define('website_sale.website_sale', function (require) {
'use strict';
        ...
        if (!config.device.isMobile) {
            ...
            _.each($('.ecom-zoomable img[data-zoom]'), function (el) {
                onImageLoaded(el, function () {
                    var $img = $(el);
                    $img.zoomGiga({event: autoZoom ? 'mouseenter' : 'click', attach: attach});
...
giga.define('website_sale.price_range_option', function (require) {
'use strict';
