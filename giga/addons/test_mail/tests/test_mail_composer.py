...
from giga.addons.test_mail.models.test_mail_models import MailTestTicket
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('giga.tests', 'giga.addons.mail.models.mail_mail')
...
class TestComposerResultsComment(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('giga.models.unlink', 'giga.addons.mail.models.mail_mail')
