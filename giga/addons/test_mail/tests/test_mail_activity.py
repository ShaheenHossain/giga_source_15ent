...
from giga import fields, exceptions, tests
...
from giga.addons.test_mail.models.test_mail_models import MailTestActivity
...
class TestActivityMixin(TestActivityCommon):
    ...
    def test_mail_activity_state(self):
        ...
        with patch('giga.addons.mail.models.mail_activity.datetime', MockedDatetime):
    ...
    def test_mail_activity_mixin_search_state_basic(self):
        ...
        with patch('giga.addons.mail.models.mail_activity.datetime', MockedDatetime), \
            patch('giga.addons.mail.models.mail_activity_mixin.datetime', MockedDatetime):
