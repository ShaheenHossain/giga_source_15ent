...
from giga import exceptions
from giga.addons.mail.tests.common import mail_new_test_user
from giga.addons.test_mail.data import test_mail_data
from giga.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE
from giga.addons.test_mail.models.test_mail_models import MailTestGateway
...
from giga.tools import email_split_and_format, formataddr, mute_logger
...
class TestMailgateway(TestMailCommon):
    ...
    @mute_logger('giga.addons.mail.models.mail_thread', 'giga.models')
    ...
    @mute_logger('giga.addons.mail.models.mail_thread')
    ...
    def test_message_process_followers(self):
        """ Incoming email: recognized author not archived and not gigabot: added as follower """
        ...
        gigabot.active = True
        gigabot.email = 'gigabot@example.com'
        with self.mock_mail_gateway():
            record4 = self.format_and_process(
                MAIL_TEMPLATE, gigabot.email_formatted, 'groups@test.com',
                subject='Gigabot Automatic Answer')

        self.assertEqual(record4.message_ids[0].author_id, gigabot)
        self.assertEqual(record4.message_ids[0].email_from, gigabot.email_formatted)
    ...
    @mute_logger('giga.addons.mail.models.mail_thread', 'giga.models.unlink', 'giga.addons.mail.models.mail_mail')
    ...
    @mute_logger('giga.addons.mail.models.mail_thread', 'giga.addons.mail.models.mail_mail', 'giga.models.unlink')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by giga should update thread accordingly """
    ...
    def test_message_process_references_external_buggy_message_id(self):
        ...
        giga should update thread accordingly. Special case when the
    ...
    @mute_logger('giga.addons.mail.models.mail_thread', 'giga.models', 'giga.addons.mail.models.mail_mail')
    ...
    def test_message_process_extra_model_res_id(self):
        """ Incoming email with ref holding model / res_id but that does not match any message in the thread: must raise since GigaERP saas-3 """
        ...
        # Giga 10 update: compat mode has been removed and should not work anymore
