giga.define('account_reports.account_report', function (require) {
'use strict';
...
var accountReportsWidget = AbstractAction.extend({
    ...
    init: function(parent, action) {
        ...
        this.giga_context = action.context;
    ...
    start: async function() {
        ...
        if("default_filter_accounts" in (this.giga_context || {}))
            this.$('.o_account_reports_filter_input').val(this.giga_context.default_filter_accounts).trigger("input");
    },
    destroy: function () {
    ...
    parse_reports_informations: function(values) {
        ...
        this.giga_context = values.context;
    ...
    trigger_action: function(e) {
        ...
        var context = new Context(this.giga_context, params.actionContext || {}, {active_id: id});
