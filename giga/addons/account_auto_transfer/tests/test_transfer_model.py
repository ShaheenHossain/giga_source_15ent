...
from giga.addons.account_auto_transfer.tests.account_auto_transfer_test_classes import AccountAutoTransferTestCase

from giga import fields
from giga.models import ValidationError
...
class TransferModelTestCase(AccountAutoTransferTestCase):
    @patch('giga.addons.account_auto_transfer.models.transfer_model.TransferModel.action_perform_auto_transfer')
    ...
    @patch('giga.addons.account_auto_transfer.models.transfer_model.TransferModel._create_or_update_move_for_period')
    ...
    @patch('giga.addons.account_auto_transfer.models.transfer_model.TransferModel._get_auto_transfer_move_line_values')
    ...
    @patch('giga.addons.account_auto_transfer.models.transfer_model.TransferModel._get_non_analytic_transfer_values')
    @patch('giga.models.BaseModel.read_group')
    ...
    @patch(
        'giga.addons.account_auto_transfer.models.transfer_model.TransferModelLine._get_destination_account_transfer_move_line_values')
