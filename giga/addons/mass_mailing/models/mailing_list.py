...
class MassMailingList(models.Model):
    ...
    def action_merge(self, src_lists, archive):
        ...
        # A (id=4): yti@gigasource.de; yti@example.com
        # B (id=5): yti@gigasource.de; yti@gigasource.de
        # C (id=6): nothing
        ...
        # ------------+---------------------------+------------------------
        #           4 | yti@gigasource.de              |          1 |        4 |
        #           6 | yti@gigasource.de              |          2 |        5 |
        #           5 | yti@example.com           |          1 |        4 |
        #           7 | yti@gigasource.de           |          1 |        5 |
        #
