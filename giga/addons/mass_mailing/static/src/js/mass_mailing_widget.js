giga.define('mass_mailing.FieldHtml', function (require) {
'use strict';
...
var MassMailingFieldHtml = FieldHtml.extend({
    ...
    _onLoadWysiwyg: function () {
        ...
        this._super();
        this.wysiwyg.gigaEditor.observerFlush();
        this.wysiwyg.gigaEditor.historyReset();
    ...
    _onSnippetsLoaded: function (ev) {
        ...
        $themeSelectorNew.on("click", ".dropdown-item", async (e) => {
            ...
            // the Giga editor before resetting the history.
            setTimeout(() => {
