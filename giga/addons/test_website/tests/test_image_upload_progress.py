...
from giga.addons.web_editor.controllers.main import Web_Editor
from giga.addons.web_unsplash.controllers.main import Web_Unsplash
...
class TestImageUploadProgress(giga.tests.HttpCase):
