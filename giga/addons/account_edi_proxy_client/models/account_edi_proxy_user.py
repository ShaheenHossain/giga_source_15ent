...
from .account_edi_proxy_auth import GigaEdiProxyAuth
...
DEFAULT_SERVER_URL = 'https://l10n-it-edi.api.gigasource.de'
TIMEOUT = 30
...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _make_request(self, url, params=False):
        ...
        try:
            response = requests.post(
                ...
                auth=GigaEdiProxyAuth(user=self)).json()
    ...
    def _renew_token(self):
        ...
        if 'error' in response:
            ...
            raise UserError('Proxy error, please contact Giga (code: 3)')
