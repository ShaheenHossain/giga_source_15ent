...
from giga.tests.common import TransactionCase, can_import
from giga.modules.module import get_module_resource
from giga.tools import mute_logger, pycompat
from giga.addons.base_import.models.base_import import ImportValidationError
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('giga.addons.base_import.models.base_import')
