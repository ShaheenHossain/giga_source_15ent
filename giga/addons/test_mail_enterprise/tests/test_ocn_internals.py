...
from giga.addons.mail.tests.common import MailCommon, mail_new_test_user
...
class TestPushNotification(MailCommon):
    ...
    def setUpClass(cls):
        ...
        sudo_icp.set_param('giga_ocn.project_id', 'Test')
    ...
    @patch('giga.addons.mail_mobile.models.mail_thread.iap_tools.iap_jsonrpc')
