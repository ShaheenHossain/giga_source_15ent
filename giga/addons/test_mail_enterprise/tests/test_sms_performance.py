...
from giga.addons.sms.tests import common as sms_common
from giga.addons.test_mail.tests.test_performance import BaseMailPerformance
...
class TestSMSPerformance(BaseMailPerformance, sms_common.SMSCase):
    ...
    @mute_logger('giga.addons.sms.models.sms_sms')
    @users('employee')
    @warmup
