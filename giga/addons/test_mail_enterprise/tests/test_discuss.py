...
from giga.addons.test_mail.tests import common as test_mail_common
...
class TestMailMobile(test_mail_common.TestMailCommon):
    ...
    def setUpClass(cls):
        ...
        cls.env['ir.config_parameter'].sudo().set_param('web.base.url', 'http://yourcompany.gigasource.de')
    ...
    def test_override_url_in_mail(self):
        ...
        original_expected_link = 'http://yourcompany.gigasource.de/mail/view?model=mail.activity&res_id=1'
