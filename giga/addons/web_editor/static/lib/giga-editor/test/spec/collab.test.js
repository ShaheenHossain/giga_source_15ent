import { GigaEditor } from '../../src/GigaEditor.js';
import {
    insertCharsAt,
...
const testMultiEditor = spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        GigaEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new GigaEditor(clientInfo.editable, {
            toSanitize: false,
    ...
    GigaEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
