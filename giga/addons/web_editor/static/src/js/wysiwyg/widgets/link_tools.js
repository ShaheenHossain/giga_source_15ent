giga.define('wysiwyg.widgets.LinkTools', function (require) {
'use strict';
...
const setSelection = GigaEditorLib.setSelection;
...
const LinkTools = Link.extend({
     ...
     */
    start: function () {
        this.options.wysiwyg.gigaEditor.observerUnactive();
    ...
    destroy: function () {
        ...
        this.options.wysiwyg.gigaEditor.observerActive();
    ...
    _onClickCustomColor: function (ev) {
        ...
        const colorpicker = new ColorPaletteWidget(this, {
            ...
            $editable: $(this.options.wysiwyg.gigaEditor.editable),
            selectedColor: color,
