giga.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in giga.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" giga domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in giga.
 */
...
/**
 * Let users choose a document, including uploading a new document in giga.
 */
