giga.define('web_editor.field.html', function (require) {
'use strict';
...
var FieldHtml = basic_fields.DebouncedField.extend(TranslatableFieldMixin, {
    ...
    _toggleCodeView: function ($codeview, $codeviewButton) {
        ...
        if ($codeview.hasClass('d-none')) {
            ...
            this.wysiwyg.gigaEditor.historyStep();
            if ($codeviewButton) {
    ...
    _onLoadWysiwyg: function () {
        ...
        if (giga.debug && this.nodeOptions.codeview) {
