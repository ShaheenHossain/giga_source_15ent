giga.define('web_editor.test_utils', function (require) {
"use strict";

var ajax = require('web.ajax');
var MockServer = require('web.MockServer');
var testUtils = require('web.test_utils');
var GigaEditorLib = require('@web_editor/../lib/giga-editor/src/GigaEditor');
...
var testKeyboard = function ($editable, assert, keyboardTests, addTests) {
    ...
    function nextPoint(point) {
        var node, offset;
        if (GigaEditorLib.nodeSize(point.node) === point.offset) {
            node = point.node.parentNode;
            offset = GigaEditorLib.childNodeIndex(point.node) + 1;
