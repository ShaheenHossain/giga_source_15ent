...
Also, adds methods to convert values back to Giga Source models.
"""
...
from giga.tools import ustr, posix_to_ldml, pycompat
from giga.tools import html_escape as escape
from giga.tools.misc import get_lang, babel_locale_parse
from giga.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = giga.modules.get_module_resource(
