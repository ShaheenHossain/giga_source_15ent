...
from giga import http, tools, _, SUPERUSER_ID
from giga.addons.http_routing.models.ir_http import slug, unslug
...
from giga.tools.image import image_data_uri, base64_to_image
...
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.gigasource.de'
