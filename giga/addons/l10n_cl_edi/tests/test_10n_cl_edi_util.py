...
class TestL10nClDte(TestL10nClEdiCommon):
    @patch('giga.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_seed_ws')
    ...
    @patch('giga.addons.l10n_cl_edi.models.l10n_cl_edi_util.Client')
    @patch('giga.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_signed_token')
    @patch('giga.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_seed_ws')
    ...
    @patch('giga.addons.l10n_cl_edi.models.l10n_cl_edi_util.Client')
    @patch('giga.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_signed_token')
    @patch('giga.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_seed')
