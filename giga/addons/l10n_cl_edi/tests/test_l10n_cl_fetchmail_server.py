...
class TestFetchmailServer(TestL10nClEdiCommon):
    ...
    @patch('giga.fields.Date.context_today', return_value=fields.Date.from_string('2019-11-23'))
    ...
    @patch('giga.addons.l10n_cl_edi.models.fetchmail_server.FetchmailServer._get_dte_lines')
