...
from giga import models, api, _, fields
from giga.osv import expression
from giga.release import version
from giga.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from giga.tools.misc import formatLang, format_date as giga_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                act = {
                    ...
                    'date': giga_format_date(self.env, activity.get('date_deadline'))
                }
