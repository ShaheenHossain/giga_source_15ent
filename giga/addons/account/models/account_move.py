...
from giga import api, fields, models, Command, _
from giga.exceptions import RedirectWarning, UserError, ValidationError, AccessError
from giga.tools import float_compare, date_utils, email_split, email_re, html_escape, is_html_empty
from giga.tools.misc import formatLang, format_date, get_lang
...
class AccountMove(models.Model):
    ...
    def _get_invoice_reference_giga_invoice(self):
        """ This computes the reference based on the Giga format.
    ...
    def _get_invoice_reference_giga_partner(self):
        """ This computes the reference based on the Giga format.
