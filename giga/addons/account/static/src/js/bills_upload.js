giga.define('account.upload.bill.mixin', function (require) {
"use strict";
...
giga.define('account.bills.tree', function (require) {
"use strict";
    var core = require('web.core');
...
giga.define('account.bills.kanban', function (require) {
...
giga.define('account.dashboard.kanban', function (require) {
"use strict";
    var core = require('web.core');
    var KanbanController = require('web.KanbanController');
    var KanbanView = require('web.KanbanView');
