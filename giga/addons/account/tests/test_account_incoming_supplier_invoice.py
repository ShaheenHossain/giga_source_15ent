...
class TestAccountIncomingSupplierInvoice(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.env['ir.config_parameter'].sudo().set_param('mail.catchall.domain', 'test-company.gigasource.de')

        cls.internal_user = cls.env['res.users'].create({
            'name': 'Internal User',
            'login': 'internal.user@test.gigasource.de',
            'email': 'internal.user@test.gigasource.de',
        })
