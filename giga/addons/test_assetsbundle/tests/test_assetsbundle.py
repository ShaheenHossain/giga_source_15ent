...
from giga import api, http
from giga.addons import __path__ as ADDONS_PATH
from giga.addons.base.models.assetsbundle import AssetsBundle
from giga.addons.base.models.ir_asset import AssetPaths
from giga.addons.base.models.ir_attachment import IrAttachment
from giga.modules.module import get_resource_path, read_manifest
...
from giga.tools import mute_logger, func
...
class TestAssetsManifest(AddonManifestPatched):
    ...
    @mute_logger('giga.addons.base.models.ir_asset')
    def test_31(self):
