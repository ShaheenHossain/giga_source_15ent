...
from giga import http, models, fields, _
from giga.http import request
from giga.osv import expression
from giga.tools import OrderedSet, escape_psql, html_escape as escape
from giga.addons.http_routing.models.ir_http import slug, slugify, _guess_mimetype
from giga.addons.portal.controllers.portal import pager as portal_pager
from giga.addons.portal.controllers.web import Home
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': giga.service.common.exp_version()
        }
