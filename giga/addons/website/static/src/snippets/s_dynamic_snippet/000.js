giga.define('website.s_dynamic_snippet', function (require) {
'use strict';
    ...
    start: function () {
        return this._super.apply(this, arguments)
            .then(() => {
                ...
                this.options.wysiwyg && this.options.wysiwyg.gigaEditor.observerUnactive();
                this._render();
                this.options.wysiwyg && this.options.wysiwyg.gigaEditor.observerActive();
            });
    },
    /**
     *
