giga.define('website.snippet.editor', function (require) {
'use strict';
...
const GigaEditorLib = require('@web_editor/../lib/giga-editor/src/utils/utils');
const getDeepRange = GigaEditorLib.getDeepRange;
const getTraversedNodes = GigaEditorLib.getTraversedNodes;
...
weSnippetEditor.SnippetsMenu.include({
    ...
    _onAnimateTextClick(ev) {
        ...
        if (this.$currentAnimatedText.length) {
            ...
            this.options.wysiwyg.gigaEditor.historyResetLatestComputedSelection();
            this._toggleHighlightAnimatedTextButton();
