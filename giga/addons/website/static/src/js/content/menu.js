giga.define('website.content.menu', function (require) {
'use strict';
...
const BaseAnimatedHeader = animations.Animation.extend({
    ...
    start: function () {
        ...
        // transitionstart, so we listen to a custom giga event.
        this._transitionCount = 0;
        this.$el.on('giga-transitionstart.BaseAnimatedHeader', () => this._adaptToHeaderChangeLoop(1));
    ...
    _updateHeaderOnScroll: function (scroll) {
        ...
        if (this.headerIsScrolled !== headerIsScrolled) {
            ...
            this.$el.trigger('giga-transitionstart');
