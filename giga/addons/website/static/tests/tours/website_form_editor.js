giga.define('website.tour.form_editor', function (require) {
    'use strict';
    ...
    tour.register("website_form_editor_tour", {
        ...
        ...addExistingField('email_cc', 'text', 'Test conditional visibility', false, {visibility: CONDITIONALVISIBILITY, condition: 'giga'}),
...

        {
            ...
            run: () => {
                ...
                wysiwyg.gigaEditor.historyStep(true);
            },
        },
        ...
        },
        {
            ...
            run: function () {
                ...
                if (style.display !== 'none') {
                    console.error('error This field should be invisible when the name is not giga');
                }
            }
        },
        {
