...
import giga
from giga.tools.misc import DotDict
...
def MockRequest(
    ...
    with contextlib.ExitStack() as s:
        giga.http._request_stack.push(request)
        s.callback(giga.http._request_stack.pop)
        s.enter_context(patch('giga.http.root.get_db_router', router))
