...
wget 'https://nightly.gigasource.de/master/iotbox/eftdvs' -P /usr/local/bin/
chmod +x /usr/local/bin/eftdvs
wget 'https://nightly.gigasource.de/master/iotbox/eftapi.so' -P /usr/lib/

groupadd usbusers
usermod -a -G usbusers pi
usermod -a -G lp pi
usermod -a -G input lightdm
mkdir -v /var/log/giga
chown pi:pi /var/log/giga
chown pi:pi -R /home/pi/giga/
...
echo "* * * * * rm /var/run/giga/sessions/*" | crontab -
...
echo "addons/hw_drivers/iot_devices/" > /home/pi/giga/.git/info/exclude
