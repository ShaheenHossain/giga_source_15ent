...
import giga
from giga import fields, tools
from giga.tools import float_compare, mute_logger, test_reports
from giga.tests.common import Form
from giga.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('giga.addons.point_of_sale.models.pos_order'):
