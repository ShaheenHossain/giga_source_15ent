...
from giga.addons.sale_subscription.tests.common_sale_subscription import TestSubscriptionCommon
from giga.tests import Form
...
class TestSubscription(TestSubscriptionCommon):
    ...
    def test_04_auto_payment_with_token(self):
        ...
        patchers = [
            patch('giga.addons.sale_subscription.models.sale_subscription.SaleSubscription._prepare_invoice_line', wraps=self._mock_prepare_invoice_line),
            patch('giga.addons.sale_subscription.models.sale_subscription.SaleSubscription._prepare_invoice_data', wraps=self._mock_prepare_invoice_data),
            patch('giga.addons.sale_subscription.models.sale_subscription.SaleSubscription._do_payment', wraps=self._mock_subscription_do_payment),
            patch('giga.addons.sale_subscription.models.sale_subscription.SaleSubscription.send_success_mail', wraps=self._mock_subscription_send_success_mail),
        ]
    ...
    @mute_logger('giga.addons.mail.models.mail_mail', 'giga.models.unlink')
