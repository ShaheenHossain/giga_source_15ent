...
from giga.http import content_disposition, request
from giga.exceptions import UserError, AccessError, ValidationError
from giga.addons.web_studio.controllers import export
from giga.osv import expression
from giga.tools import ustr, sql
...
class WebStudioController(http.Controller):
    ...
    def _generate_studio_view_name(self, view):
        return "Giga Studio: %s customization" % (view.name)
