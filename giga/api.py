...
"""The Giga API module defines Giga Environments and method decorators.
...
def constrains(*args):
    ...
    Should raise :exc:`~giga.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~giga.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/giga/giga/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def envs(cls):
        raise NotImplementedError(
            "Since Giga 15.0, Environment.envs no longer works; "
    ...
    def manage(cls):
        warnings.warn(
            "Since Giga 15.0, Environment.manage() is useless.",
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~giga.addons.base.models.res_users`
            :type su: bool
        """
    ...
    def user(self):
        ...
        :rtype: :class:`~giga.addons.base.models.res_users`"""
    ...
    def clear_upon_failure(self):
        ...
        """
        warnings.warn(
            "Since Giga 15.0, use cr.savepoint() instead of env.clear_upon_failure().",
            DeprecationWarning, stacklevel=2,
        )
...
from giga.exceptions import UserError, AccessError, MissingError
