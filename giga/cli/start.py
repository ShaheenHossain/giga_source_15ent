...
from giga.modules.module import get_module_root, MANIFEST_NAMES
from giga.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the Giga server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            giga.tools.config['init']['base'] = True
