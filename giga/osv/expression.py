...
term representation was ['=', 'company_id.name', 'GigaERP']. Used in a
...
GigaERP will use the SQL function 'unaccent' when available for the
...
Finally, to instruct GigaERP to really use the unaccent function, you have to
...
import giga.modules
from giga.osv.query import Query
...
def get_unaccent_wrapper(cr):
    if giga.registry(cr.dbname).has_unaccent:
